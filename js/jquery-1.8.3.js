...
jQuery.fn.extend({
	seckill:function(time){
		var $hour=this.find('.hour');
		var $minute=this.find('.minute');
		var $second=this.find('.second');
		var endTime=new Date(time).getTime();
		var timer=setInterval(function(){
				var endMsecond=endTime-new Date().getTime();
				if(endMsecond>1){
					var hour=Math.floor(endMsecond/1000/60/60);
					var minute=Math.floor(endMsecond/1000/60%60);
					var second=Math.floor(endMsecond/1000%60);
